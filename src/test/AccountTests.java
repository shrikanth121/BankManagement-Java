...
public class AccountTests {
    ...
    public void withdrawal() {
        accounts[0].withdrawal(1440);
        assertEquals(84.51, accounts[0].getAmount());
    }

    @Test
    public void overdraft() {
        accounts[0].withdrawal(1534.43);
        assertEquals(-15.42, accounts[0].getAmount());
    }

    @Test
    public void overdraftLimit() {
        accounts[0].withdrawal(1726);
        assertEquals(1524.51, accounts[0].getAmount());
    }

    @Test
    public void withdrawalFee() {
        accounts[1].withdrawal(100);
        assertEquals(2136.60, accounts[1].getAmount());
    }

    @Test
    public void withdrawalInterest() {
        accounts[2].withdrawal(2434.31);
        assertEquals(5020.31, accounts[2].getAmount());
    }

    @Test
    public void withdrawalLimit() {
        accounts[2].withdrawal(7463.69);
        assertEquals(2537.31, accounts[2].getAmount());
    }

    @Test
    public void deposit() {
        accounts[0].deposit(5000);
        assertEquals(6524.51, accounts[0].getAmount());
    }

    @Test
    public void loanDeposit() {
        accounts[2].deposit(1000);
        assertEquals(1537.31, accounts[2].getAmount());
    }
    ...
    public void incomeTax() {
        ...
        assertEquals(5374.51, accounts[0].getAmount());
    }
